...
// チャット画面(先生用)
// Route::get('/teacher/chat/{tid}/{id}', [App\Http\Controllers\HomeController::class, 'teacherChat']);
...
Route::get('/teacher/chat/{id}', [App\Http\Controllers\MessageController::class,'t_chat'])->name('message.chat');
