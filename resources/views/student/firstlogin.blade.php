                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('/student/firstlogin') }}">
                        ...
                        <div class="text-center bg-warning rounded-3">
                            ...
                            <p>ようこそ、{{ '$login_user->last_name' }} さん。</br>初回ログインの為、パスワードを変更してください。</p>
                        </div>
                        ...
                        <div class="row mb-3">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-end">{{ __('再入力') }}</label>
