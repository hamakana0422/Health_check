...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <h1>〇〇小学校 体調管理システム</br>＜体調を報告する画面です＞</h1>
        <div>
        ...
        <div>
            ...
            <input type="text" name="day" size = "35">
        </div>
        <div>
        ...
        <script>
            <button type="button">報告する</button>
        </script>
        <button type="button">キャンセル</button></br>
        <button type="button">過去に報告した内容を確認/編集する</button>
    </body>
</html>