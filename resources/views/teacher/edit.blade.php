...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('東京小学校　体調管理システム<アカウント編集画面>') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('/teacher/edit') }}">
                        ...
                        <div class="row mb-3">
                            <label for="email" class="col-md-4 col-form-label text-md-end">{{ __('現在のメールアドレス') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="email" class="col-md-4 col-form-label text-md-end">{{ __('新しいメールアドレス') }}</label>
